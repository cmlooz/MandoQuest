...
class UniformCost:
    ...
    def execute(self):
        ...
        while not nodes_queue.is_empty():
            ...
            self.print_node(curr_node=curr_node)
...
class CustomPriorityQueue:
    ...
    def push(self, current_node):
        tmp_node = CustomNode(curr_cost=current_node.current_cost, curr_node=current_node)
...
class CustomNode:
    def __init__(self, curr_cost, curr_node):
